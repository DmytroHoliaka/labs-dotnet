...
Упродовж семестр були вивчені надважливі концепції мови програмування C# та .NET загалом. Закріплено підходи до роботи із послідовностями за допомогою LINQ із використанням query та method syntax. Зробуто навички роботи із XML файлами, використовуючи підхід LINQ to XML (System.Xml.Linq) та стандартний DOM-підхід (System.Xml). Далі було теоретично вивчено і закріплено на практиці способи роботи із JSON-файлами.
